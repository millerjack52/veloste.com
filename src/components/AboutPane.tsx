          ...
          >
            ...
            <header className="v-about-header">
              ...
              <p className="v-about-header-sub">
                Veloste is a creative studio focused on immersive,
                interaction-led web experiences. We combine graphic systems, 3D
                canvases, and thoughtful affordances to build surfaces that feel
                unmistakably yours—and intuitively usable.
              </p>
            </header>
                ...
                <div className="v-visual-card">
                  ...
                  <div className="v-visual-canvas-wrapper">
                    <Canvas
                      key={currentScene}
                      camera={{
                        position: [0, 0, currentScene === "particles" ? 7 : 4],
                      }}
                      style={{
                        width: "100%",
                        height: "100%",
            ...
            >
              <div className="v-footer-inner">
                <div className="v-footer-text">
                  ...
                  <br />
                  IMMERSIVE WEB EXPERIENCES, CRAFTED FOR THE PEOPLE WHO USE
                  THEM.
                </div>
              </div>
            </footer>
